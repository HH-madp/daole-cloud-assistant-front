...
vjs.Player.prototype.unloadTech = function(){
  ...
  // Turn off any level progress or timeupdate tracking
...
vjs.Player.prototype.manualProgressOn = function(){
  ...
  // So we're assuming they don't, and turning off level progress if they do.
  ...
  this.tech.one('progress', function(){
    ...
    // Turn off level progress tracking
...
vjs.Player.prototype.currentTime = function(seconds){
  if (seconds !== undefined) {
    ...
    // improve the accuracy of level timeupdates
